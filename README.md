...
One solution for the 0-1 Knapsack Problem is 

*Indispensable:
-Real world problem
-Real world data
-State the importance of your selected problem/solution
